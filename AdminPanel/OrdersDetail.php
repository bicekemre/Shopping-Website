...
<table width="760" align="center" border="0" cellpadding="0" cellspacing="0">
    <tr height="70">
        ...
        <td width="200" bgcolor="#FF9900" align="right"><a href="index.php?PageCodeLog=0&PageCodeA=106" style="color: #FFFFFF; text-decoration: none;">ORDERS (Waiting)&nbsp;</a></td>
    </tr>
    <tr height="10">
    ...
    <tr>
        ...
        <tr>
            <td colspan="2">
                <form action="index.php?PageCodeLog=0&PageCodeA=110&OrderNo=<?php echo FiltersDecode($IncomingOrderNO); ?>" method="post">
                    <table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
                        <tr height="40">
                            <td colspan="3">
                                <table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td width="100"><b>Shipping Code</b></td>
                                        <td width="10"><b>:</b></td>
                                        <td width="540"><input type="text" name="ShippingCode" class="InputArea"></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                            ...
                            <td colspan="3">
                                <table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td width="100">&nbsp;</td>
                                        <td width="10">&nbsp;</td>
                                        <td width="540"><input type="submit" value="Send" class="SendButton"></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
